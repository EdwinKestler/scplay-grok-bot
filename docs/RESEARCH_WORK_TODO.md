...
- [ ] Add a machine-readable registry for experimental conditions, including controller tier, map, opponent, mode, chaos, real-time setting, and decision cadence.
...
- [ ] Define versioned JSON Schemas for the run manifest, gameplay events, chat events, snapshots, and LLM decisions.
